...
export declare const transactionSk2ToPurchaseMap: ({ id, originalPurchaseDate, productID, purchaseDate, purchasedQuantity, originalID, verificationResult, appAccountToken, appTransactionID, jsonRepresentation, jwsRepresentationIos, environmentIos, storefrontCountryCodeIos, reasonIos, offerIos, priceIos, currencyIos, }: TransactionSk2) => Purchase;
/**
